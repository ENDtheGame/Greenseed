        ...
        <div class="block mt-4">
            <label for="remember_me" class="inline-flex items-center">
                <input id="remember_me" type="checkbox"
                    class="rounded border-slate-300 text-green-600 shadow-sm focus:ring-green-500 focus:ring-offset-0"
                    name="remember">
                <span class="ms-2 text-sm text-slate-600 font-medium"><?php echo e(__('Remember me')); ?></span>
            </label>
        </div>

        <div class="flex items-center justify-end mt-4">
            <?php if(Route::has('password.request')): ?>
                <a class="text-sm text-slate-500 hover:text-green-600 font-medium transition-colors duration-200 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500"
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\Greenseed\resources\views/auth/login.blade.php ENDPATH**/ ?>